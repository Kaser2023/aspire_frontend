...
import { statsService, paymentsService, branchesService } from '../../services'
...
export default function Financial() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [statsRes, paymentsRes, branchesRes] = await Promise.all([
      ...
      if (statsRes.success && statsRes.data) {
        setStats({
          totalRevenue: statsRes.data.total_income || 0,
          totalExpenses: statsRes.data.total_refunds || 0,
          netProfit: statsRes.data.net_revenue || 0,
          pendingPayments: statsRes.data.pending_payments?.amount || 0
        })
      }
  ...
  }, [activeTab, filterBranchId, language])
  ...
  const handlePaymentSubmit = async (e) => {
    ...
    if (programs.length > 0 && !selectedProgramId) {
      setError(language === 'ar' ? 'اختر برنامجاً أولاً' : 'Please select a program')
      return
    }
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          {language === 'ar' ? 'نظرة عامة على المالية والمدفوعات' : 'Overview of finances and payments'}
        </p>
      </div>
        <Button
          onClick={() => {
        ...
        <GlassCard className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{language === 'ar' ? 'الاستردادات' : 'Refunds'}</p>
            </div>
          </div>
        </GlassCard>
        <GlassCard className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-bold text-purple-500">{formatCurrency(stats.netProfit)}</p>
        ...
        <GlassCard className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{language === 'ar' ? 'معلقة' : 'Pending'}</p>
            </div>
          </div>
          </GlassCard>
      </div>
      ...
      <GlassCard className="p-6">
        <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold text-secondary dark:text-white">
              {editingPaymentId ? (language === 'ar' ? 'تعديل الدفعة' : 'Edit Payment') : (language === 'ar' ? 'تسجيل دفعة جديدة' : 'Record New Payment')}
            </h3>
          ...
          {branches.length === 0 ? (
            ...
            <form onSubmit={handlePaymentSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                    required
                  >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100"
                    />
                  </div>
                  {receiptPreview && (
                    <div className="mt-3">
              ...
              <div className="flex items-center gap-3">
                <Button type="submit" className="bg-purple-500 hover:bg-purple-600" disabled={submitting}>
                  {submitting
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <p className="font-semibold text-purple-600">{formatCurrency(payment.total_amount || payment.amount || 0)}</p>
                  </div>
                  <div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-white/10">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-500/10 disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      disabled={payment.status === 'refunded' || payment.status === 'cancelled' || submitting}
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      onClick={() => handleEditPayment(payment)}
                      disabled={payment.status === 'cancelled'}
                      className="p-1.5 rounded-lg text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-500/10 disabled:opacity-50"
