...
export default function Settings() {
  ...
  const initials = user ? `${user.first_name?.charAt(0) || ''}${user.last_name?.charAt(0) || ''}`.toUpperCase() : 'BA'
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          {language === 'ar' ? 'إدارة ملفك الشخصي وتفضيلاتك' : 'Manage your profile and preferences'}
        </p>
      </div>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="relative group">
                  {avatarPreview ? (
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold">
                      {initials || 'U'}
                    </div>
                  )}
                  <button
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-500">{language === 'ar' ? 'مدير الفرع' : 'Branch Admin'}</p>
