  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 dark:bg-emerald-500/10 rounded-lg text-xs text-emerald-600 dark:text-emerald-400">
      ...
      {notifications.length > 0 ? (
        <div className="space-y-3">
          {notifications.map((announcement) => {
            ...
            return (
              <GlassCard key={announcement.id} className="p-4 transition-all hover:shadow-md border-l-2 border-emerald-500/70">
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-full bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400 flex items-center justify-center flex-shrink-0">
