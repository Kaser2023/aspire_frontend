...
export default function Settings() {
  ...
  const initials = user ? `${user.first_name?.charAt(0) || ''}${user.last_name?.charAt(0) || ''}`.toUpperCase() : 'AC'
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          {language === 'ar' ? 'إدارة الحساب والإعدادات الشخصية' : 'Manage account and personal settings'}
        </p>
      </div>
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 mb-6">
                <div className="relative group">
                  {avatarPreview ? (
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-2xl flex items-center justify-center text-white text-2xl font-bold">
                      {initials || 'AC'}
                    </div>
                  )}
                  <button
                ...
                <div>
                  <p className="font-bold text-secondary dark:text-white">
                    {fullName || (language === 'ar' ? 'المحاسب' : 'Accountant')}
                  </p>
                  <p className="text-sm text-teal-500">{language === 'ar' ? 'محاسب' : 'Accountant'}</p>
              ...
              <Button
                ...
                disabled={loading}
                className="w-full mt-4 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600"
              >
